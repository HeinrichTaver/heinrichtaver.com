		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.b_) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.b8, record.b_, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {bf: charset, b$: finalDeclarations, bo: imports, bv: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bf: charset, b$: declarations, bo: imports, bv: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bf: $elm$core$Maybe$Nothing, bo: _List_Nil, bv: _List_Nil, bI: snippets};
};
...
var $author$project$Main$bodyView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('My name is Heinrich.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('For now, this is just a playground.')
				]))
		]));
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($rtfeldman$elm_css$Css$property, 'margin', '0 auto')
					]))
			]),
		_List_fromArray(
			[$author$project$Main$headerView, $author$project$Main$bodyView, $author$project$Main$footerView]));
};
var $author$project$Main$main = $rtfeldman$elm_css$Html$Styled$toUnstyled(
